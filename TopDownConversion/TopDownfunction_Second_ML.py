...
def converttopdown(Hue, Saturation, Value, ROImask, cornermask, InputPic, OutputPic, Pic_size=(1920, 1080), plotcorner=False, plotline=False, automode=True):
    ...
    if(automode):
        ...
        cv2.imwrite('line_image_afterS.jpeg', line_image_after) #斜率合併後所得到的線
        cv2.waitKey()
    ...
    image_TopDown1 = cv2.warpPerspective(InputPic, M1, Pic_size)
    image_TopDown2 = cv2.warpPerspective(InputPic, M2, Pic_size)
    ...
    return image_TopDown1, image_TopDown2, connectline